...
const ProductCard = ({ prod, onEnquire, style = "default" }) => {
  ...
  if (style === "deal") {
    return (
      <div className={`${cardShell} flex-shrink-0 kure-catalog-deal-card`} style={{ width: 252, minWidth: 252 }}>
        {imageBlock}
...
const Home = ({ featuredProducts, allProducts, homepageSettings, brands }) => {
  ...
  return (
    ...
    >
      ...
      <BreakthroughDrugs onEnquiry={() => setGenericEnquiryOpen(true)} />
      ...
      <SupplyBanners onEnquiry={() => setGenericEnquiryOpen(true)} />
      ...
      <SpecialtyTrust onEnquiry={() => setGenericEnquiryOpen(true)} />
        ...
        allProducts?.length > 0 && (
          <section className="kure-section kure-section-cream">
            <div className="kure-container">
              ...
              {/* Product Grid */}
              <div className="kure-catalog-grid grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
                {allProducts
                  .filter(
                    (p) =>
                      !activeCatFilter ||
