        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 relative">
            ...
            <Image
              ...
              alt="Why Choose ILMIC Health Care"
              width={600}
              height={600}
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-4xl font-extrabold text-[#051124] mb-6">Why Hundreds of Businesses Trust ILMIC Health Care</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              With years of experience in the industry, ILMIC Health Care is dedicated to providing affordable and high-quality safety testing services. We focus on reliability, professionalism, and customer satisfaction.
            </p>
