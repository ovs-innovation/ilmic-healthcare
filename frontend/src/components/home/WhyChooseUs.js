      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-4xl font-extrabold text-[#051124] mb-6">Why Hundreds of Businesses Trust Kure Pharma</h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              With years of experience in the industry, Kure Pharma is dedicated to providing affordable and high-quality safety testing services. We focus on reliability, professionalism, and customer satisfaction.
            </p>
