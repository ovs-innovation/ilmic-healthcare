...
const testimonials = [
  {
    ...
    avatar: "D",
    avatarBg: "bg-red-800",
    text: "We use ILMIC Health Care Test and Tag Services. They are very professional, reliable, always on time, and send the reports usually the next day. Very Happy with their Service",
    hasImage: false,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    text: "Very prompt and Professional service. Urgently needed a job done first thing the following day. The Boys at ILMIC Health Care moved some jobs around to help me out. Will definitely use again.",
    hasReadMore: false,
  },
  {
    id: 4,
