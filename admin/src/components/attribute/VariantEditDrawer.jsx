...
const VariantEditDrawer = ({
  ...
  const handleSlugGeneration = (title) => {
    if (!title) return;
    console.log("handleSlugGeneration called with:", title); // Debug log
    ...
    setCurrentSlug(slug); // Also update local state
    setIsSlugAutoGenerated(true);
  };
  ...
  const handleTitleChange = (e) => {
    ...
    if (title && title.trim()) {
      ...
      setCurrentSlug(""); // Also clear local state
      setIsSlugAutoGenerated(false);
    }
  };
  ...
  const handleSlugChange = (e) => {
    ...
    setCurrentSlug(formattedSlug); // Update local state
